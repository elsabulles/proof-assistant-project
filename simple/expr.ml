...
(* 1.1 Simple types. A simple type is either a type variable or an implication between simple types. Define a type ty for simple types. *)
type ty =
...
| True
| InjLeft of ty*tm | InjRight of ty*tm | Case of tm*var*tm*var*tm
